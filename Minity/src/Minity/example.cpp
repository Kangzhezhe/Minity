...
int example() {
	try {
		...
		// Backtrace support
		// Loggers can store in a ring buffer all messages (including
		// debug/trace) for later inspection. When needed, call dump_backtrace()
...
void mdc_example() {
	...
	// if not using the default format, you can use the %& formatter to print
	// mdc data as well
